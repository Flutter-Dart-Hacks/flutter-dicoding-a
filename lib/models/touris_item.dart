...
List<TourismPlace> tourismPlaceList = [
  TourismPlace(
    ...
    imageAsset: 'resources/images/farm-house.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAsset: 'resources/images/bosscha.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'resources/images/jalan-asia-afrika.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAsset: 'resources/images/stone-garden.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'resources/images/taman-film.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAsset: 'resources/images/museum-geologi.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 20000',
    imageAsset: 'resources/images/floating-market.png',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAsset: 'resources/images/kawah-putih.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Rp 20000',
    imageAsset: 'resources/images/ranca-upas.jpg',
    imageUrls: [
